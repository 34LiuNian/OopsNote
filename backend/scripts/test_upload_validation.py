...
def test_upload_request():
    ...
    try:
        ...
        print("✓ Test 1 PASSED: Valid base64 request")
    ...
    try:
        ...
        req2 = UploadRequest(
            image_url=HttpUrl("https://example.com/image.png"), subject="chemistry"
        )
        print("✓ Test 2 PASSED: Valid URL request")
    ...
    try:
        ...
        print("✓ Test 4 PASSED: Frontend-like payload")
        print("  - All optional fields handled correctly")
    except Exception as e:
